...
class m180816_185140_add_document_external_storage extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->addColumn('document', 'filesystem_id', $this->string(45)->notNull()->defaultValue('local-sql'));
    }
    ...
    public function safeDown()
    {
        ...
        if($ret > 0) {
            echo "m180816_185140_document_contents_is_nullable cannot be reverted when `document.local_contents` column contain NULL items.\n";
            return false;
        }
        $this->renameColumn('document', 'local_contents', 'contents');
        $this->alterColumn('document', 'contents', "LONGBLOB NOT NULL");
        $this->dropColumn('document', 'filesystem_id');
